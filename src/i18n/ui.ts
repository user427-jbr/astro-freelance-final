...
export const ui = {
  de: {
    ...
    'about.body':      'Mein Antrieb ist es, Menschen in ihrem Arbeitsalltag spürbar zu entlasten. Repetitive Aufgaben, manuelle Dateneingaben und umständliche Prozesse rauben wertvolle Zeit – Zeit, die besser in echte Wertschöpfung investiert werden sollte. Genau hier setze ich an: Ich entwickle Lösungen, die nicht nur technisch sauber sind, sondern die Nutzer dort abholen, wo sie stehen – intuitiv, verlässlich und direkt im vertrauten Microsoft-Umfeld.',
  ...
  en: {
    ...
    'about.body':      "My motivation is simple: I want to make people's daily work genuinely easier. Repetitive tasks, manual data entry, and clunky processes drain time that could be spent on work that actually matters. That's where I come in — building solutions that are not only technically sound but meet users exactly where they are: intuitive, reliable, and right inside the Microsoft tools they already know.",
